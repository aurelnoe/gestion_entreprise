...
function head()
{
    ...
    <script src="../Communs/jquery-3.5.1.min.js"></script>
    <script src="../Communs/scriptServices.js" type="text/javascript"></script>
    <script src="../Communs/scriptEmployes.js" type="text/javascript"></script>
    <?php
}
